<?php
    ...
    // Add a new record
    function add_superhero($db, $hero_name, $identity, $image, $description) {
        try {
            $query = "INSERT INTO superheroes (hero_name, identity, image, description) 
                      VALUES (:hero_name, :identity, :image, :description);";
            $statement = $db->prepare($query);
            $statement->bindValue(':hero_name', $hero_name);
            $statement->bindValue(':identity', $identity);
